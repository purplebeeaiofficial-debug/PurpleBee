    ...
    "ko-KR": {
        ...
        "pages": {
            ...
            "pricing": {
                ...
                "plans": [
                    {"name": "Free", "headline": "유지 조건 없음", "badge": "Free", "features": ["기본 AI 대화", "내 기기 연산", "표준 우선순위", "기본 사용 한도"]},
                    {"name": "Basic", "headline": "월 8시간 기여 유지", "badge": "Basic", "features": ["보조 연산 모드 선택", "응답 제한 완화", "월 8시간 유지 조건", "기여 앱 설치 가능"]},
                    {"name": "Plus", "headline": "주 10시간 · 월 40시간 유지", "badge": "Plus", "recommended": True, "features": ["상위 우선순위", "더 넓은 모델 접근", "주 10시간 · 월 40시간 유지", "하이브리드/보조 연산"]},
                    {"name": "Pro", "headline": "주 20시간 · 월 80시간 유지", "badge": "Pro", "features": ["최상위 우선순위", "대형 작업 대응", "주 20시간 · 월 80시간 유지", "강한 보조 연산 배정"]},
                ],
                "sections": [],
            },
        },
    ...
    "en-US": {
        ...
        "pages": {
            ...
            "pricing": {
                ...
                "badges": ["Free", "Basic", "Plus", "Pro"],
                "plans": [
                    {"name": "Free", "headline": "No maintenance required", "badge": "Free", "features": ["Basic AI chat", "Local compute", "Standard priority", "Base usage limits"]},
                    {"name": "Basic", "headline": "8h per month", "badge": "Basic", "features": ["Assist compute modes", "Softer limits", "8h monthly maintenance", "Contributor app access"]},
                    {"name": "Plus", "headline": "10h/week · 40h/month", "badge": "Plus", "recommended": True, "features": ["Higher priority", "Broader model access", "10h/week · 40h/month", "Hybrid and assist compute"]},
                    {"name": "Pro", "headline": "20h/week · 80h/month", "badge": "Pro", "features": ["Top priority", "Large-job support", "20h/week · 80h/month", "Strong assist allocation"]},
                ],
                "sections": [],
            },
        },
    ...
    "ja-JP": {
        ...
        "pages": {
            ...
            "pricing": {
                ...
                "badges": ["Free", "Basic", "Plus", "Pro"],
                "plans": [
                    {"name": "Free", "headline": "維持条件なし", "badge": "Free", "features": ["基本 AI 会話", "ローカル演算", "標準優先度", "基本利用上限"]},
                    {"name": "Basic", "headline": "月 8 時間維持", "badge": "Basic", "features": ["補助演算モード", "利用制限緩和", "月 8 時間維持", "貢献アプリ利用"]},
                    {"name": "Plus", "headline": "週 10 時間・月 40 時間維持", "badge": "Plus", "recommended": True, "features": ["高優先度", "より広いモデル利用", "週 10 時間・月 40 時間", "ハイブリッド補助演算"]},
                    {"name": "Pro", "headline": "週 20 時間・月 80 時間維持", "badge": "Pro", "features": ["最上位優先度", "大規模処理対応", "週 20 時間・月 80 時間", "強い補助演算配分"]},
                ],
                "sections": [],
            },
        },
